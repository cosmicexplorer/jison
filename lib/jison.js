...
var ItemSet = Jison.ItemSet = class ItemSet {
    ...
    static WrapForSetOf(initialValue) {
        console.dir({w: this, initialValue});
    ...
    constructor(elements) {
        ...
        // FIXME: we should move the "id extraction" logic to static wrapper methods like
        //        WrapForSetOf, and remove this implicit method call in the constructor entirely!
...
lrGeneratorMixin.canonicalCollection = function canonicalCollection () {
    ...
    // const idSet = Object.;
    const ww = Jison.ItemSet.WrapForSetOf(item1);
    throw new Error('okww');
